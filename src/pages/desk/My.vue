  ...
  <view-box ref="viewBox" class="my">
    ...
    <div class="personWrap marginTop" @click="jumpPerson">
      <div class="personPhoto">
        <img src="../../assets/img_my.png" />
      </div>
      <p class="personName" v-if="!token">未登录<b class="icon_arrow"></b></p>
      <p class="personName" v-if="token">{{company}}<b class="icon_arrow"></b></p>
    </div>
    <ul class="passwordList">
      ...
      <li @click="jumpBillingSetting">
        <img src="../../assets/icon_my_kpms.png" />
        <p class="leftCon">开票设置<b class="icon_arrow"></b></p>
      </li>
...
export default {
  ...
  methods:{
    ...
    jumpMyList(){  //我的发票列表
      ...
      this.$router.push({path:'/desk_my_list'});
    },
    jumpBillingSetting(){  //开票设置
      if(!this.token){
        this.showAlertLogin = true;
        this.text = '请先登录';
        return false;
      }
      this.$router.push({path:'/desk_billing_setting'});
    },
    jumpPrivacy(){  //隐私政策
      if(!this.token){
        this.showAlertLogin = true;
      ...
      this.$router.push({path:'/desk_privacy'})
    },
    jumpAbout(){  //关于
      if(!this.token){
        this.showAlertLogin = true;
      ...
      this.$router.push({path:'/desk_about'})
    },
    jumpGoodsTitle(){  //商品信息
      if(!this.token){
        this.showAlertLogin = true;
      ...
      this.$router.push({path:'/desk_goods_list',query:{isMy:"true"}})
    },
    //点击退出
    clickOut(){
      this.showAlert = true;
    ...
    logout(){
      ...
      var _this = this;
      var url = this.local+'/api/desk/logout';
      var data = {
